...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    try {
        ...
        querySnapshot.forEach((doc) => {
            ...
            files.push({
                ...
                audioDataUri: data.url, // Changed from audioDataUri to url
  ...
  const uploadAudioFile = async (file: File) => {
    ...
    const { id: toastId, update } = toast({ title: "Uploading...", description: `"${file.name}" is being uploaded.` });
    ...
    try {
        ...
        // This is a simplified approach for the prototype. A real app would have a backend process
        // to properly extract duration and generate a real transcript.
        ...
        update({ id: toastId, title: "Success", description: "File uploaded and processed." });
