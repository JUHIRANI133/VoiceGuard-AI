...
const callHistory = [
  ...
  { id: 8, 'type': 'Incoming', 'contact': 'Sunita Mehta', duration: '2:55', date: '2024-07-24', risk: 'low', transcript: "Speaker2: Hi, Maa! How are you today? Speaker1: Aruna! I’m fine, beta. Just finished my tea. I was thinking of you, so I called. How’s work at KIIT? Speaker2: Busy as always. I had back-to-back lectures today, and the final-year students are preparing for their project submissions. Speaker1: Ah, the same story every year. Are you taking care of your health? You sound a little tired. Speaker2: Yes, Maa, don’t worry. Rishab made lemon ginger tea for me this morning, so I’m okay. Speaker1: Good, good. And how’s Aarav? Speaker2: Oh, he’s busy coding as usual. I think he’s planning to build some AI tool for his class assignment. Speaker1: Just like his mother! Smart and hardworking. Tell him not to skip meals. Speaker2: I will, Maa. By the way, I’m thinking of visiting you next weekend. We can cook together like old times. Speaker1: That would be wonderful. I’ll make your favorite aloo paratha. Speaker2: Perfect! Okay, Maa, I have to get ready for my evening lecture. I’ll call you again tomorrow. Speaker1: Alright, beta. Take care. Love you. Speaker2: Love you too, Maa. Bye.", voice: 'maia' },
];
